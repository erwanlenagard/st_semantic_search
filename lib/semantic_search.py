...
def connect_with_connector() -> sqlalchemy.engine.base.Engine:
    ...
    instance_connection_name = st.secrets['INSTANCE'] # e.g. 'project:region:instance'
    db_user = st.secrets['USER']  # e.g. 'my-db-user'
    db_pass = st.secrets['PASSWORD']  # e.g. 'my-db-password'
    db_name = st.secrets['DATABASE']  # e.g. 'my-database'
